...
func TestCompile(t *testing.T) {
	test := []TestComp{
		{"Multi( (34+35)*2, Multi( citizenId, 56))", "[1 34][1 35][512 25][1 2][514 30][2 citizenId][1 56][7 Multi][7 Multi]"},
		{"myfunc1() + myfunc2(10+56)*myfunc3((5+id), func4(qwerty), 6*(3+8))", "[7 myfunc1][1 10][1 56][512 25][7 myfunc2][1 5][2 id][512 25][2 qwerty][7 func4][1 6][1 3][1 8][512 25][514 30][7 myfunc3][514 30][512 25]"},
		{`10 + #mytable[id = 234].name * 20`, `[1 10][5 mytable][5 id][1 234][5 name][6 50][1 20][514 30][512 25]`},
		...
		{"(8 +11))+56", "[1 8][1 11][512 25][14 there is not pair ) [Ln:1 Col:8]]"},
		{"(99+ 76)(1+67", "[1 99][1 76][512 25][1 1][1 67][512 25][14 there is not pair [Ln:1 Col:9]]"},
