		...
		INSERT INTO "%[1]d_tables" ("id", "name", "permissions","columns", "conditions") VALUES 
			...
			"conditions": "ContractConditions(\"MainCondition\")"
				...
				('9', 'members', 
					...
					'ContractConditions(\"MainCondition\")'),
				('10', 'roles', 
					'{"default_page":"false","creator":"false","deleted":"ContractAccess(\"Roles_Del\")","company_id":"false","date_deleted":"ContractAccess(\"Roles_Del\")",
					"image_id":"ContractAccess(\"Roles_Create\")","role_name":"false","date_created":"false","role_type":"false"}',
					   'ContractConditions(\"MainCondition\")'),
				('11', 'roles_participants',
					'{"insert":"ContractAccess(\"Roles_Assign\",\"voting_CheckDecision\")","update":"ContractConditions(\"MainCondition\")","new_column":"ContractConditions(\"MainCondition\")"}',
					'{"deleted":"ContractAccess(\"Roles_Unassign\")","date_deleted":"ContractAccess(\"Roles_Unassign\")","member":"false","role":"false","date_created":"false","appointed":"false"}', 
					  'ContractConditions(\"MainCondition\")'),
				('12', 'notifications',
					'{"insert":"ContractAccess(\"Notifications_Single_Send_map\",\"Notifications_Roles_Send_map\")","update":"ContractConditions(\"MainCondition\")","new_column":"ContractConditions(\"MainCondition\")"}',
					'{"date_closed":"ContractAccess(\"Notifications_Single_Close\",\"Notifications_Roles_Close\")","sender":"false","processing_info":"ContractAccess(\"Notifications_Single_Close\",\"Notifications_Roles_Processing\")",
					"date_start_processing":"ContractAccess(\"Notifications_Single_Close\",\"Notifications_Roles_Processing\")","notification":"false","page_name":"false","page_params":"false","closed":"ContractAccess(\"Notifications_Single_Close\",\"Notifications_Roles_Close\")","date_created":"false","recipient":"false"}',
					'ContractAccess(\"@1EditTable\")'),
				('13', 'sections', 
					'{"insert": "ContractConditions(\"MainCondition\")", "update": "ContractConditions(\"MainCondition\")", 
					"new_column": "ContractConditions(\"MainCondition\")"}',
