...
var (
	Schema = `DROP TABLE IF EXISTS "transactions_status"; CREATE TABLE "transactions_status" (
		...
		('extend_cost_address_to_id', '10', 'true'),
		('extend_cost_id_to_address', '10', 'true'),
		('extend_cost_new_state', '1000', 'true'), -- What cost must be?
		('extend_cost_sha256', '50', 'true'),
		('extend_cost_pub_to_id', '10', 'true'),
		('extend_cost_ecosys_param', '10', 'true'),
		('extend_cost_sys_param_string', '10', 'true'),
		('extend_cost_sys_param_int', '10', 'true'),
		('extend_cost_sys_fuel', '10', 'true'),
		('extend_cost_validate_condition', '30', 'true'),
		('extend_cost_eval_condition', '20', 'true'),
		('extend_cost_has_prefix', '10', 'true'),
		('extend_cost_contains', '10', 'true'),
		('extend_cost_replace', '10', 'true'),
		('extend_cost_join', '10', 'true'),
		('extend_cost_update_lang', '10', 'true'),
		...
		('extend_cost_len', '5', 'true'),
		('extend_cost_activate', '10', 'true'),
		('extend_cost_deactivate', '10', 'true'),
		('extend_cost_create_ecosystem', '100', 'true'),
		('extend_cost_rollback_ecosystem', '100', 'true'),
		('extend_cost_table_conditions', '100', 'true'),
		('extend_cost_create_table', '100', 'true'),
		('extend_cost_rollback_table', '100', 'true'),
		('extend_cost_perm_table', '100', 'true'),
		('extend_cost_column_condition', '50', 'true'),
		('extend_cost_create_column', '50', 'true'),
		('extend_cost_rollback_column', '50', 'true'),
		('extend_cost_perm_column', '50', 'true'),
		('extend_cost_json_to_map', '50', 'true');
