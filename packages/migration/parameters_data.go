...
INSERT INTO "1_parameters" ("id","name", "value", "conditions", "ecosystem") VALUES
	...
	(next_id('1_parameters'),'changing_signature', 'ContractConditions("MainCondition")', 'ContractConditions("@1DeveloperCondition")', '%[1]d'),
	...
	(next_id('1_parameters'),'max_tx_block_per_user', '100', 'ContractConditions("@1DeveloperCondition")', '%[1]d'),
	...
	(next_id('1_parameters'),'ecosystem_wallet', '', 'ContractConditions("@1DeveloperCondition")', '%[1]d'),
	(next_id('1_parameters'),'error_page', '@1error_page', 'ContractConditions("@1DeveloperCondition")', '%[1]d');
`
