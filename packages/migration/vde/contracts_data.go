...
INSERT INTO "%[1]d_contracts" ("id", "name", "value", "wallet_id", "conditions", "app_id") VALUES 
		...
		('2', 'DelApplication', 'contract DelApplication {
        data {
            ApplicationId int
            Value int "optional"
        }
...
}', %[2]d, 'ContractConditions("NodeOwnerCondition")', 1),
