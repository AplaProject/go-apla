...
var SchemaVDE = `DROP TABLE IF EXISTS "vde_languages"; CREATE TABLE "vde_languages" (
		"id" bigint  NOT NULL DEFAULT '0',
		"name" character varying(100) NOT NULL DEFAULT '',
		"res" text NOT NULL DEFAULT ''
	  );
	  ALTER TABLE ONLY "vde_languages" ADD CONSTRAINT "vde_languages_pkey" PRIMARY KEY (id);
	  CREATE INDEX "vde_languages_index_name" ON "vde_languages" (name);
	  
	  DROP TABLE IF EXISTS "vde_menu"; CREATE TABLE "vde_menu" (
		  "id" bigint  NOT NULL DEFAULT '0',
	  ...
	  ALTER TABLE ONLY "vde_menu" ADD CONSTRAINT "vde_menu_pkey" PRIMARY KEY (id);
	  CREATE INDEX "vde_menu_index_name" ON "vde_menu" (name);
	  
	  DROP TABLE IF EXISTS "vde_pages"; CREATE TABLE "vde_pages" (
		  "id" bigint  NOT NULL DEFAULT '0',
		  "name" character varying(255) UNIQUE NOT NULL DEFAULT '',
		  "value" text NOT NULL DEFAULT '',
	  ...
	  ALTER TABLE ONLY "vde_pages" ADD CONSTRAINT "vde_pages_pkey" PRIMARY KEY (id);
	  CREATE INDEX "vde_pages_index_name" ON "vde_pages" (name);
	  
	  DROP TABLE IF EXISTS "vde_blocks"; CREATE TABLE "vde_blocks" (
		  "id" bigint  NOT NULL DEFAULT '0',
		  "name" character varying(255) UNIQUE NOT NULL DEFAULT '',
		  "value" text NOT NULL DEFAULT '',
		  "conditions" text NOT NULL DEFAULT ''
	  );
	  ALTER TABLE ONLY "vde_blocks" ADD CONSTRAINT "vde_blocks_pkey" PRIMARY KEY (id);
	  CREATE INDEX "vde_blocks_index_name" ON "vde_blocks" (name);
	  
	  DROP TABLE IF EXISTS "vde_signatures"; CREATE TABLE "vde_signatures" (
		  "id" bigint  NOT NULL DEFAULT '0',
		  "name" character varying(100) NOT NULL DEFAULT '',
		  "value" jsonb,
		  "conditions" text NOT NULL DEFAULT ''
	  );
	  ALTER TABLE ONLY "vde_signatures" ADD CONSTRAINT "vde_signatures_pkey" PRIMARY KEY (name);
	  
	  CREATE TABLE "vde_contracts" (
	  "id" bigint NOT NULL  DEFAULT '0',
	  "value" text  NOT NULL DEFAULT '',
	  "conditions" text  NOT NULL DEFAULT ''
	  );
	  ALTER TABLE ONLY "vde_contracts" ADD CONSTRAINT "vde_contracts_pkey" PRIMARY KEY (id);
	  
	  DROP TABLE IF EXISTS "vde_parameters";
	  CREATE TABLE "vde_parameters" (
	  "id" bigint NOT NULL  DEFAULT '0',
	  "name" varchar(255) UNIQUE NOT NULL DEFAULT '',
	  "value" text NOT NULL DEFAULT '',
	  "conditions" text  NOT NULL DEFAULT ''
	  );
	  ALTER TABLE ONLY "vde_parameters" ADD CONSTRAINT "vde_parameters_pkey" PRIMARY KEY ("id");
	  CREATE INDEX "vde_parameters_index_name" ON "vde_parameters" (name);
	  
	  INSERT INTO "vde_parameters" ("id","name", "value", "conditions") VALUES 
	  ('1','founder_account', '%[1]d', 'ContractConditions("MainCondition")'),
	  ...
	  DROP TABLE IF EXISTS "vde_cron";
	  CREATE TABLE "vde_cron" (
		  "id"        bigint NOT NULL DEFAULT '0',
	  ...
	  ALTER TABLE ONLY "vde_cron" ADD CONSTRAINT "vde_cron_pkey" PRIMARY KEY ("id");


	  CREATE TABLE "vde_tables" (
	  "id" bigint NOT NULL  DEFAULT '0',
	  ...
	  ALTER TABLE ONLY "vde_tables" ADD CONSTRAINT "vde_tables_pkey" PRIMARY KEY ("id");
	  CREATE INDEX "vde_tables_index_name" ON "vde_tables" (name);
	  
	  INSERT INTO "vde_tables" ("id", "name", "permissions","columns", "conditions") VALUES ('1', 'contracts', 
	  ...
	  INSERT INTO "vde_contracts" ("id", "value", "conditions") VALUES 
