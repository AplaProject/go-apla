...
func staticAdvanced_citizenshipTpl() (*asset, error) {
	path := "static/advanced_citizenship.tpl"
...
func staticMoney_busenessTpl() (*asset, error) {
	path := "static/money_buseness.tpl"
