...
// static/anonym_block_generation.html
...
// staticAnonym_block_generationHtml reads file data from disk. It returns an error on failure.
func staticAnonym_block_generationHtml() (*asset, error) {
	path := "static/anonym_block_generation.html"
	name := "static/anonym_block_generation.html"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
var _bindata = map[string]func() (*asset, error){
	...
	"static/anonym_block_generation.html": staticAnonym_block_generationHtml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"static": &bintree{nil, map[string]*bintree{
		...
		"anonym_block_generation.html": &bintree{staticAnonym_block_generationHtml, map[string]*bintree{}},
