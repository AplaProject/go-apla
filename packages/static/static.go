...
// staticAccountsTpl reads file data from disk. It returns an error on failure.
func staticAccountsTpl() (*asset, error) {
	path := "static/accounts.tpl"
	name := "static/accounts.tpl"
...
var _bindata = map[string]func() (*asset, error){
	"static/accounts.tpl": staticAccountsTpl,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"static": &bintree{nil, map[string]*bintree{
		"accounts.tpl": &bintree{staticAccountsTpl, map[string]*bintree{}},
