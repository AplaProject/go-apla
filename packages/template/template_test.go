...
var forTest = tplList{
	...
	{`Button(Body: addpage, 
		Contract: NewPage, VDE: URL is here,
		Params: "Name=hello_page2, Value=Div(fefe, dbbt), Menu=default_menu, Conditions=true")`,
		`[{"tag":"button","attr":{"contract":"NewPage","params":{"Conditions":{"text":"true","type":"text"},"Menu":{"text":"default_menu","type":"text"},"Name":{"text":"hello_page2","type":"text"},"Value":{"params":["fefe","dbbt"],"type":"Div"}},"vde":"URL is here"},"children":[{"tag":"text","text":"addpage"}]}]`},
