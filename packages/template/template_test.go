...
var forTest = tplList{
	{`SetVar(text, test)Code(P(Some #text#))CodeAsIs(P(No Some #text#))Div(){CodeAsIs(Text:#text#)}`,
		`[{"tag":"code","attr":{"text":"P(Some test)"}},{"tag":"code","attr":{"text":"P(No Some #text#)"}},{"tag":"div","children":[{"tag":"code","attr":{"text":"#text#"}}]}]`},
