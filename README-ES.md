...
Establezca [derechos](https://GenesisCommunity.readthedocs.io/en/latest/introduction/what-is-Apla.html#access-rights-control-mechanism) para cambiar el código de contrato  interfaz y los datos de registro
...
Por favor, lea el [CONTRIBUTING.md](https://github.com/GenesisCommunity/go-genesis/blob/master/CONTRIBUTING.md)  para obtener más información sobre el proceso de envío de Pull Requests.

## Documentación
Por favor, estudie y complemente [nuestra documentación](https://GenesisCommunity.readthedocs.io/en/latest/#contents)


## Versiones
Usamos [SemVer](http://semver.org/) para el control de las versiones. Versiones disponibles: ver [tags on this repository](https://github.com/GenesisCommunity/go-genesis/tags)
...
Ver también la lista de [participantes](https://github.com/GenesisCommunity/go-genesis/graphs/contributors) que formaron parte en
este proyecto.<br>
...
Este proyecto se encuentra bajo la licencia de GPLv3- ver el archivo de [LICENCIA ](https://github.com/GenesisCommunity/go-genesis/blob/master/LICENSE) para más detalles
