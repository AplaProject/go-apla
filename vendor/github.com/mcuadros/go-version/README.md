...
```
go get github.com/EGaaS/go-mvp/vendor/src/github.com/mcuadros/go-version
```
...
```go
import (
    "github.com/EGaaS/go-mvp/vendor/src/github.com/mcuadros/go-version"
)
```
