...
func TestFormatFuncName(t *testing.T) {
	var tests = []struct {
		...
		{"main.main",
			...
			"main",
			"main"},
		{"github.com/EGaaS/go-egaas-mvp/vendor/github.com/op/go-logging.func·001",
			"github.com/EGaaS/go-egaas-mvp/vendor/github.com/op/go-logging",
			"go-logging",
			"func·001",
			"func·001"},
		{"github.com/EGaaS/go-egaas-mvp/vendor/github.com/op/go-logging.stringFormatter.Format",
			"github.com/EGaaS/go-egaas-mvp/vendor/github.com/op/go-logging",
			"go-logging",
