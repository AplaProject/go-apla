...
func TestFormatFuncName(t *testing.T) {
	var tests = []struct {
		...
		{"main.main",
			...
			"main",
			"main"},
		{"github.com/AplaProject/go-apla/vendor/github.com/op/go-logging.func·001",
			"github.com/AplaProject/go-apla/vendor/github.com/op/go-logging",
			"go-logging",
			"func·001",
			"func·001"},
		{"github.com/AplaProject/go-apla/vendor/github.com/op/go-logging.stringFormatter.Format",
			"github.com/AplaProject/go-apla/vendor/github.com/op/go-logging",
			"go-logging",
