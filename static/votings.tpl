...
Divs(md-6, panel panel-default panel-body data-sweet-alert)
    Divs(panel-heading)
        ...
        Form()
            ...
            TxButton{Class: btn col-xs-12, ClassBtn:btn btn-lg btn-square btn-primary btn-block btn-oval,  Contract: RF_next_event,Name: $StartVote$,Inputs:"Start=1", OnSuccess:"template,RF_UserVotingList"}
    ...
    Divs(text-center) 
     MarkDown: <br/>
        ...
        Form()
            ...
            TxButton{ClassBtn: btn btn-oval btn-info,Class:btn text-center,Contract:RF_NextVoting,Name: $Next$,Inputs:"IdIssue=IdIssue",OnSuccess:"template,RF_UserVotingList"}
            DivsEnd:
        FormEnd:
...
Divs(md-6, panel panel-default panel-body data-sweet-alert)
    Divs(panel-heading)
        ...
        TxButton{Class: col-xs-12, ClassBtn: btn col-xs-12 btn-oval btn-lg btn-success, Contract: RF_Voting,Name: $Confirm$,Inputs:"ReferendumId=ReferendumId,RFChoice=RFChoice", OnSuccess: "template,RF_UserVotingList"}
        DivsEnd:
        DivsEnd:
        FormEnd:
...
SetVar(`m_Referendum = [Nieuwe vraag](RF_NewIssue)
[Beheerder](RF_List)
[Land overzicht](government)`,
`m_RF_UserVoting = [Gebruiker](dashboard_default)
[Stemlijst](RF_StartPage)
[Einde Stemmen](RF_UserList)
`)
...
Desc: "Voting",
		...
		Data: {
			...
			columns: '[["issue", "text", "0"],["number_0", "int64", "1"],["number_votes", "int64", "1"],["result", "int64", "1"],["status", "int64", "1"],["number_1", "int64", "1"],["date_enter", "time", "1"],["date_voting_start", "time", "1"],["date_voting_finish", "time", "1"]]',
	   ...
	   },
{
		...
		Data: {
			...
			general_update: "$citizen == #wallet_id#",
			insert: "",
			new_column: "$citizen == #wallet_id#",
			}
	   },
{
		Forsign: 'global,table_name,columns',
	   ...
	   },
{
		...
		Data: {
			...
			global: 0,
			table_name : "rf_votes",
			columns: '[["hash", "text", "0"],["time", "time", "1"],["choice", "int64", "1"],["strhash", "hash", "1"],["referendum_id", "int64", "1"]]',
			permissions: "$citizen == #wallet_id#"
			}
	   },
{
